...
class VFAPollinator(DynamixelHelloXL430):
    ...
    def home(self,move_to_zero=False):
        DynamixelHelloXL430.home(self,single_stop=True,move_to_zero=False,delay_at_stop=3.0)
    ...
    def step_sentry(self, robot):
        """This sentry attempts to prevent the pollinator servo from overheating during a prolonged grasp
        ...
        commanded current. The pollinator's spring design allows it to retain its grasp despite the backoff.
        """
        DynamixelHelloXL430.step_sentry(self, robot)
        if self.hw_valid and self.robot_params['robot_sentry']['stretch_pollinator_overload'] and not self.is_homing:
    ...
    def movetostartpos(self):
        ...
        x_r = self.ticks_to_world_rad(900)	
